...
const insuranceArrangements = [
  { name: 'כללית מושלם', className: 'clalit', note: 'קבלת מטופלים במסגרת כללית מושלם' },
  { name: 'מכבי', className: 'maccabi', note: 'בהסדר / בהתאם לזכאות' },
  { name: 'מאוחדת', className: 'meuhedet', note: 'בהסדר / בהתאם לזכאות' },
  { name: 'לאומית משלים', className: 'leumit', note: 'החזר בהתאם לזכאות' },
  { name: 'כלל ביטוח', className: 'clal', note: 'החזר בהתאם לתנאי הפוליסה' },
];
    ...
    <main>
      ...
      <section className="about section" id="about">
        ...
        <div className="aboutCopy">
          ...
          <div className="factsGrid">
            ...
            <div><span>05</span><p>רופא עצמאי במכבי ובמאוחדת.</p></div>
            <div><span>06</span><p>מדריך בפקולטה לרפואה של אוניברסיטת בן־גוריון.</p></div>
          </div>
        </div>
      </section>
      ...
      <section className="insurance section" id="insurance">
        <div className="sectionHead splitHead insuranceHead">
          <div>
            <span className="eyebrow">החזרים והסדרים</span>
            <h2>החזרים דרך קופות וביטוחים.</h2>
          </div>
          <p>ניתן לבדוק זכאות להסדר או להחזר עבור הייעוץ מול הקופה או חברת הביטוח. ד״ר סגל מקבל גם במסגרת כללית מושלם. הזכאות וגובה ההחזר נקבעים לפי המסלול או הפוליסה האישית.</p>
        </div>
        ...
        <p className="insuranceNote">המידע מוצג לנוחות המטופלים. לפני הזמנת תור מומלץ לוודא מול הקופה או חברת הביטוח את סוג ההסדר, הזכאות וגובה ההחזר.</p>
      </section>
      ...
      <footer>
        ...
        <div className="footerRight"><span>יצחק בן צבי 9, באר שבע</span><span>WhatsApp: {whatsappDisplay}</span><span>טלפון: {phoneDisplay}</span><small>Clinic website • v005</small></div>
      </footer>
    </main>
  );
}
