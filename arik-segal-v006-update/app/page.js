  ...
  return (
    <main>
      ...
      <footer>
        ...
        <div className="footerRight"><span>יצחק בן צבי 9, באר שבע</span><span>WhatsApp: {whatsappDisplay}</span><span>טלפון: {phoneDisplay}</span><small>Clinic website • v006</small></div>
      </footer>
    </main>
  );
}
